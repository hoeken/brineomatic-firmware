#ifndef _CONFIG_H_BRINEOMATIC_REV_C
#define _CONFIG_H_BRINEOMATIC_REV_C

#include "ADS1X15.h"

#define YB_HARDWARE_VERSION "BRINEOMATIC_REV_C"
...
#define YB_RELAY_CHANNEL_COUNT 5
#define YB_RELAY_CHANNEL_PINS  {6, 7, 15, 16, 8}
...
#define YB_420_RESISTOR        100.0

static const float YB_ADC_VREF[4] = {ADS1x15_GAIN_4096MV_FSRANGE_V, ADS1x15_GAIN_4096MV_FSRANGE_V, ADS1x15_GAIN_2048MV_FSRANGE_V, ADS1x15_GAIN_2048MV_FSRANGE_V};
static const uint8_t YB_ADC_GAIN[4] = {ADS1X15_GAIN_4096MV, ADS1X15_GAIN_4096MV, ADS1X15_GAIN_2048MV, ADS1X15_GAIN_2048MV};
...
#define YB_STEPPER_STEP_PINS     {17}
#define YB_STEPPER_DIR_PINS      {18}
#define YB_STEPPER_ENABLE_PINS   {11}
#define YB_STEPPER_DIAG_PINS     {21}
